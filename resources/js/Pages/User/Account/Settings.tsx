            ...
            <div className="mt-8">
              <div className="grid grid-cols-3 gap-6">
                <div className="col-span-1">
                  <div className="w-full px-3 lg:flex-0 shrink-0">
                    <div className="sticky flex flex-col min-w-0 break-words bg-white border-0 top-1/100 rounded-xl shadow-lg">
                      <ul className="flex flex-col flex-wrap p-4 mb-0 list-none rounded-xl">
                        <li>
                          ...
                          >
                            ...
                            <span className="leading-normal text-sm text-slate-600">
                              Profile
                            </span>
                          </a>
                        </li>
                ...
                <div className="col-span-2">
                  <div className="w-full m-auto bg-white relative flex flex-col flex-auto min-w-0 p-2 overflow-hidden break-words rounded-xl shadow-lg">
                  ...
                  <div className="mt-6">
                    <div className="w-full bg-white shadow-lg rounded-xl p-8">
                      ...
                      {/* Form Steps */}
                      <div>
                        <h2 className="text-lg font-bold mb-4">Basic Form</h2>
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              placeholder="Tudun wadan pantami..."
                              className="mt-1 block w-full border border-gray-300 py-2 px-3.5 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 outline-none"
                            />
                          </div>
                          <div>
                        ...
                        <div className="mt-4">
                          ...
                          <select className="mt-1 block w-full border appearance-none bg-white text-slate-600 border-gray-300 py-2 px-3.5 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 outline-none">
                            <option value="" hidden>
                              Select Gender
                            </option>
                    ...
                    <div className="w-full bg-white shadow-lg rounded-xl p-8">
                      ...
                      <div>
                        ...
                        <form>
                          ...
                          <div className="flex mt-12 w-full flex-wrap justify-between">
                            <div>
                            ...
                            <div>
                              <button className="float-right px-8 py-2 mt-16 mb-0 font-bold text-right text-white uppercase transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 bg-gradient-to-tl from-green-500 to-green-800 text-xs ease-soft-in">
                                Update Password
                              </button>
                            </div>
                          </div>
                  ...
                  <div className="mt-6">
                    ...
                    >
                      <div className="flex p-6 rounded-t-2xl">
                        <h5 className="mb-0 text-slate-600 font-bold text-lg">
                          Two-factor authentication
                        </h5>
                        <span className="py-2 px-3 text-xs rounded-1.8 ml-auto inline-block whitespace-nowrap bg-lime-200 text-center align-baseline font-bold uppercase leading-none text-lime-600">
                          Enabled
                        </span>
                      </div>
                      <div className="flex-auto p-6">
                        <div className="flex">
                          ...
                          <p className="my-auto ml-auto mr-4 leading-normal text-sm text-slate-600">
                            No Security Keys
                          </p>
                        ...
                        <div className="flex">
                          <p className="my-auto text-slate-600">SMS number</p>
                          <p className="my-auto ml-auto mr-4 leading-normal text-sm text-slate-600">
                            +4012374423
                          </p>
                          <button className="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer active:opacity-85 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:scale-102 active:shadow-soft-xs border-slate-700 text-slate-700 hover:text-slate-700 hover:opacity-75 hover:shadow-none active:scale-100 active:border-slate-700 active:bg-slate-700 active:text-white hover:active:border-slate-700 hover:active:text-slate-700 hover:active:opacity-75">
                  ...
                  <div className="mt-6">
                    ...
                    >
                      <div className="p-6 rounded-t-2xl">
                        <h5 className="text-slate-600">Notifications</h5>
                        ...
                        <div className="overflow-x-auto">
                          <table className="w-full mb-0 align-top border-gray-200 text-slate-500 dark:border-white/40">
                            <thead className="align-bottom">
                              <tr>
                                <th className="px-6 py-3 pl-1 font-semibold text-left capitalize align-middle bg-transparent border-b border-solid shadow-none tracking-none whitespace-nowrap border-b-gray-200 dark:border-white/40">
                                  <p className="mb-0 text-slate-600">
                                    Activity
                                  </p>
                                </th>
                                <th className="px-6 py-3 font-semibold text-left capitalize align-middle bg-transparent border-b border-solid shadow-none tracking-none whitespace-nowrap border-b-gray-200 dark:border-white/40">
                                  <p className="mb-0 text-slate-600">Email</p>
                                </th>
                                <th className="px-6 py-3 font-semibold text-left capitalize align-middle bg-transparent border-b border-solid shadow-none tracking-none whitespace-nowrap border-b-gray-200 dark:border-white/40">
                                  <p className="mb-0 text-slate-600">Push</p>
                                </th>
                                <th className="px-6 py-3 font-semibold text-left capitalize align-middle bg-transparent border-b border-solid shadow-none tracking-none whitespace-nowrap border-b-gray-200 dark:border-white/40">
                                  <p className="mb-0 text-slate-600">SMS</p>
                                </th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td className="p-2 pl-1 align-top border-b whitespace-nowrap dark:border-white/40">
                                  <div className="my-auto">
                                    <span className="block leading-normal text-sm text-slate-700">
                                      Mentions
                                    </span>
                                    <span className="font-normal leading-tight text-xs text-slate-600">
                                      Notify when another user mentions you in a
                                      comment
                                    </span>
                                  </div>
                                </td>
                                <td className="p-2 align-top bg-transparent border-b whitespace-nowrap dark:border-white/40">
                              ...
                              <tr>
                                ...
                                <td className="p-2 align-top bg-transparent border-b-0 whitespace-nowrap dark:border-white/40">
                                  <li className="relative ml-4 block px-0 py-2 border-0 text-inherit">
                                    <div className="min-h-6 mb-0.5 block pl-0">
                                      <label className="inline-flex gap-3 items-center cursor-pointer">
                                        <input
                  ...
                  <div className="mt-6">
                    ...
                    >
                      <div className="p-6 rounded-t-2xl">
                        <h5 className="text-slate-600">Delete Account</h5>
                        <p className="mb-0 leading-normal text-sm text-slate-600">
                          ...
                          <div className="min-h-6 mb-0.5 block pl-0">
                            <div>
                              <label className="inline-flex gap-3 items-center cursor-pointer">
                                ...
                                <div>
                                  <span className="block font-semibold leading-normal text-sm text-slate-700 ">
                                    Confirm
                                  </span>
                                  <label
                                    className="w-4/5 mb-0 overflow-hidden font-normal cursor-pointer text-sm text-ellipsis whitespace-nowrap text-slate-500"
                                    htmlFor="flexSwitchCheckDefault1"
                                  >
