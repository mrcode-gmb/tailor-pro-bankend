    ...
    <>
      <div className="relative">
        <div className="grid grid-cols-2 max-lg:grid-cols-1 m-auto">
          <div className="h-screen w-full bg-gray-200 relative flex items-center overflow-hidden">
            <div className="bg-white shadow-lg rounded-lg w-9/12 p-4 max-sm:w-11/12 m-auto">
              <div className="mb-3">
              ...
              <div>
                <div className="-mt-1 mb-4">
                  <Link to={`/forgot-password`} className="text-slate-600 text-ellipsis">
                    Forgot password ?
                  </Link>
                </div>
              </div>
              <div>
                <div className="my-2 -mt-1 flex items-center gap-4 justify-end max-sm:justify-between">
                  <Link to={`/register`} className="text-slate-600 text-ellipsis">
                    Create Account
                  </Link>
