                  ...
                  <div className="p-5">
                    ...
                    Discrive your style
                      ...
                      <textarea
                        ...
                        className="w-full border resize-none outline-none py-2.5 px-4 text-sm border-gray-300 focus:border-green-500 focus:shadow-sm placeholder:text-gray-400 mt-1 rounded-lg"
                      ></textarea>
                    </div>
                    <div>
                      <button
...
export default AIGeneartiveStyleFolder;
