...
const AddMeasurementComponent = () => {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className="justify-center w-full items-center flex overflow-x-hidden overflow-y-auto fixed z-50 outline-none focus:outline-none">
            <div className="relative w-full my-6 mx-auto" id="geModal">
              {/*content*/}
              <div
                className={`border-0 rounded-lg shadow-lg w-4/12 max-lg:w-8/12 max-md:w-11/12 m-auto relative flex bg-white outline-none focus:outline-none
              ${isVisible
