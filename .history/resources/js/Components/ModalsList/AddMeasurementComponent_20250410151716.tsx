...
const AddMeasurementComponent = () => {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className="justify-center w-full p-4 items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
          ...
          transition-all duration-300 ease-in-out
              ...
              >
                ...
                <div className="relative flex-auto">
                  ...
                  <div className="p-5">
                    <div className="mb-6">
                      <div className="grid grid-cols-2 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6">
                        <div>
