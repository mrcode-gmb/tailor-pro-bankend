            ...
            {sidebarData.map((menu:any) => (
              <li key={menu.title} className="list-item">
                <div
                  ...
                  className="flex cursor-default items-center justify-between gap-2 py-3 px-3 hover:bg-white rounded-lg"
                >
                ...
                {openMenus[menu.title] && menu.children && (
                  <ul className="ml-10 mt-2 space-y-2 text-slate-600 transition-all du">
