  ...
  return (
    <>
      ...
      <div className="py-2 max-xl:p-0">
        <div className="flex bg-white w-full fixed left-0 z-40 top-0 w-full justify-between items-center p-3">
          <div className="flex items-center gap-6">
            <div className="">
                <div className="flex items-center gap-3 border-b-slate-50 max-xl:pt-8">
                  <img src="@/../../assets/Screenshot_from_2025-03-23_17-12-19-removebg-preview.png" className="w-30[px]" alt="" />
                </div>
            </div>
            <div
