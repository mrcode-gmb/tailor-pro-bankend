      ...
      >
        ...
        <nav className="py-12 ">
          <ul className="gap-y-3">
            ...
            <li>
              <Link to={`/my-tailors-chat`} className="flex items-center gap-2 py-3 px-3 hover:bg-white rounded-lg">
                <div className="bg-white text-slate-600 shadow-md rounded-lg size-8 flex">
            ...
            <div className="relative">
              ...
              >
                <li className="list-none p-5 py-1 transition-all duration-200 hover:underline">
                  <Link to={""} className="text-nowrap text-sm">
                    My Account
                  </Link>
                </li>
                <li className="list-none p-5 py-1 transition-all duration-200 hover:underline">
