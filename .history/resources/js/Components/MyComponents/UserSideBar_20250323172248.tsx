      ...
      <div className="">
        <div className="flex bg-white w-full fixed left-0 z-40 top-0 shadow-md justify-between items-center px-4 py-2">
          ...
          <div className="flex justify-end items-center gap-5 text-slate-600">
            <div className="relative w-full flex max-xl:hidden">
              <input
                type="search"
                placeholder="Type here..."
                className="p-3 py-2 w-auto outline-none rounded-lg text-sm border border-gray-300 focus:border-green-600"
              />
            </div>
