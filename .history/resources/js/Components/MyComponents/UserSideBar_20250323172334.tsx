            ...
            <div className="flex gap-3 items-center font-extrabold text-xl text-gray-600">
              ...
              <div className="relative flex max-xl:hidden ml-10">
                <input
                  ...
                  className="p-3 py-2 outline-none w-[200px] rounded-lg text-sm border border-gray-300 focus:border-green-600"
                />
              </div>
            </div>
          ...
          <div className="flex justify-end items-center gap-5 text-slate-600">
            <div className="relative flex max-xl:hidden">
              <input
                type="search"
                placeholder="Type here..."
                className="p-3 py-2 w-[10%] outline-none rounded-lg text-sm border border-gray-300 focus:border-green-600"
              />
            </div>
