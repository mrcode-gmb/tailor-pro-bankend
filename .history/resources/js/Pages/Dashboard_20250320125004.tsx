...
import BarChart from "@/Components/MyComponents/BarChart";
import LineChart from "@/Components/MyComponents/LineChart";
                        ...
                        <div className="mt-6 relative">
                            ...
                            <div className="mt-8">
                                <div className="grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-6">
                                    <div
                                        className={`w-full h-full max-lg:h-80 relative flex items-center overflow-hidden rounded-2xl bg-[url('@/../../public/assets/Pastedimage.png')] bg-cover bg-center p-0`}
                                    >
