...
import img1 from "@/../../public/assets/140859-green-and-black-waves-curved-lines-background.jpg"
        ...
        <>
            <div className="relative">
                <div className="grid grid-cols-2 max-lg:grid-cols-1 m-auto">
                    ...
                    <div className={`bg-[url('@/../../public/assets/140859-green-and-black-waves-curved-lines-background.jpg')] max-lg:hidden bg-cover bg-center h-screen w-full relative flex items-center overflow-hidden`}>
