    ...
    <>
      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className="gap-6 mt-10 font-sans lg:bg-transparent justify-center flex lg:flex-row lg:top-1/2 lg:left-1/2 lg:transform lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 px-5 xl:px-0 py-8 lg:py-0  lg:items-stretch">
