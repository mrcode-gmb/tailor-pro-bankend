    ...
    <>
      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className="font-sans lg:bg-transparent flex flex-col lg:flex-row  mt-6 justify-center lg:top-1/2 lg:left-0 lg:transform lg:translate-x-0 lg:translate-y-0 xl:px-0 lg:py-0 w-full gap-6 items-center lg:items-stretch"
          >
          {PRICING_DATA.map((data, index) => (
            <div key={index} className="relative">
              <div className="max-w-sm xl:w-[384px] shadow-lg p-6 bg-white group h-full rounded-2xl lg:hover:-translate-y-6 ease-in duration-300 hover:bg-green-500 hover:text-white border xl:border-none">
                ...
                <div className="h-36">
                  <div className="bottom-6 left-6 right-6 absolute">
                    ...
                    <button className="w-full px-4 py-3 bg-[#FFF5FA] text-green-800 group-hover:text-white group-hover:bg-green-300 rounded-xl mt-6 font-semibold text-xl">
                      Choose
                    </button>
                  </div>
                </div>
