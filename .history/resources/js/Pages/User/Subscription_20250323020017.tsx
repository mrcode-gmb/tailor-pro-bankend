...
const Subscription = () => {
  ...
  return (
    <>
      ...
      <section>
        <div className="2xl:w-10/12 m-10 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          <div>
          ...
          <div className="gap-6 font-sans lg:bg-transparent flex flex-col lg:flex-row  justify-center lg:top-1/2 lg:left-1/2 lg:transform">
