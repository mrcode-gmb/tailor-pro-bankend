        ...
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          {PRICING_DATA.map((data, index) => (
            <div key={index} className="relative">
              <div className="max-w-sm xl:w-[384px] shadow-lg p-6 bg-white group h-full rounded-2xl lg:hover:-translate-y-6 ease-in duration-300 hover:bg-green-500 hover:text-white border xl:border-none border-[#0B0641]">
