    ...
    <>
      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className="font-sans lg:bg-transparent flex flex-col lg:flex-row  mt-6 justify-center lg:top-1/2 lg:left-1/2 lg:transform lg:translate-x-0 lg:translate-y-0 px-5 xl:px-0 lg:py-0 w-full gap-6 items-center lg:items-stretch bg-red-500"
          >
          {PRICING_DATA.map((data, index) => (
            <div key={index} className="relative">
              <div className="max-w-sm xl:w-[384px] shadow-lg p-6 bg-white group h-full rounded-2xl lg:hover:-translate-y-6 ease-in duration-300 hover:bg-green-500 hover:text-white border xl:border-none  max-sm:w-full">
