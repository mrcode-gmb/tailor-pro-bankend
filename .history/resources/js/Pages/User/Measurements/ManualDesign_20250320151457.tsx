...
import User from "../../Component/SideBar";
      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          <div>
            ...
            <SideBar pageTitle="Profile Overview" />
            {/* end content header side bar component  */}
          </div>

          {/* start dashboad  */}
          <div
            className={`w-full h-80 relative flex items-center overflow-hidden rounded-2xl bg-[url('/../src/assets/Pastedimage.png')] bg-cover bg-center p-0`}
          >
          ...
          <div className="w-full">
              ...
              <div>
                <div className="bg-white shadow-lg p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    <img
                      src="/src/assets/home-decor-2.jpg"
            ...
            <div className="mt-12 text-center">
              <button className="py-4 px-6 bg-green-500 text-white rounded-lg font-semibold">Save & Continue</button>
            </div>
          </div>
