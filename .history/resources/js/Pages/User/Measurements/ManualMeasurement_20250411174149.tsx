                        ...
                        <div className="bg-white p-4 rounded-lg shadow-lg">
                            ...
                            <div className="border border-border/50 p-6 rounded-xl shadow-sm max-w-4xl mx-auto">
                                <div className="pb-2 flex flex-row items-center justify-between space-y-0 gap-4">
                                    <div>
                                        <div className="text-sm text-muted-foreground f flex items-center mb-1">
                                        ...
                                        <div key={"Full Jampah"}>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2">
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground f text-gray-500">{"Sholder Width"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground f text-gray-500">{"Shirt Length"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground f text-gray-500">{"Zawon Wando"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground f text-gray-500">{"Wuyan Riga"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground f text-gray-500">{"Zawon Hannu"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                ...
                                <footer className="pt-1 text-sm text-muted-foreground f">
