                                        ...
                                        <div key={"Full Jampah"}>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2">
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground">{"Sholder Width"}:</span>
                                                    <span className="font-medium text-sm text-gray-500">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground">{"Shirt Length"}:</span>
                                                    <span className="font-medium text-sm text-gray-500">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground">{"Zawon Wando"}:</span>
                                                    <span className="font-medium text-sm text-gray-500">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground">{"Wuyan Riga"}:</span>
                                                    <span className="font-medium text-sm text-gray-500">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground">{"Zawon Hannu"}:</span>
                                                    <span className="font-medium text-sm text-gray-500">{"29"} in</span>
                                                </div>
