                    ...
                    <div className="w-full">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-lg">
                            ...
                            <div className="border border-border/50 p-6 rounded-xl shadow-sm max-w-4xl mx-auto">
                                ...
                                <div className="pb-3">
                                    <div className="flex items-center gap-2 mb-4 mt-1 p-3 bg-green-50 rounded-md">
                                        <div
                                            className="flex-shrink-0 w-12 h-12 rounded-full bg-green-100 text-green-300 flex items-center justify-center"
                                        >
                                        ...
                                        <div key={"Full Jampah"}>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2">
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground text-gray-500">{"Sholder Width"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground text-gray-500">{"Shirt Length"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground text-gray-500">{"Zawon Wando"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground text-gray-500">{"Wuyan Riga"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                                    <span className="text-sm text-muted-foreground text-gray-500">{"Zawon Hannu"}:</span>
                                                    <span className="font-medium text-sm">{"29"} in</span>
                                                </div>
                                ...
                                <footer className="pt-1 text-sm text-muted-foreground">
                                    <p className="text-gray-500">Measurement ID: {"id-23-10"}</p>
                                </footer>
                            </div>
                        </div>
                    </div>
