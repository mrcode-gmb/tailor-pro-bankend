                        ...
                        <div className="bg-white p-4 rounded-lg shadow-lg">
                            ...
                            <div className="border border-border/50 p-6 rounded-xl shadow-sm max-w-4xl mx-auto">
                                <div className="pb-2 flex flex-row items-center justify-between space-y-0 gap-4">
                                    <div>
                                        <div className="text-sm text-muted-foreground text-nowrap flex items-center mb-1">
                                            <Clock className="fa fa-cloc text-nowrapk  &nbh-3  w-3 mr-2" />
                                        ...
                                        <div key={"Full Jampah"}>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2">
                                                <div className="flex justify-between items-center py-1">
                                                    ...
                                                    <span className="font-medium text-sm text-nowrap"> &nb{"29 "} in</span>
                                                </div>
                                                <div className="flex justify-between items-center py-1">
                                ...
                                <footer className="pt-1 text-sm text-muted-foreground text-nowrap">
                                    <p className="text-gray-500">Measurement ID text-nowrap:  &nb{"id -23-10"}</p>
                                </footer>
                            </div>
                        </div>
                    </div>
