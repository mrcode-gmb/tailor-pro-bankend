      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          <div>
            ...
            <SideBar pageTitle="Smart AI Mesurement" />
          ...
          <div className="w-full">
            ...
            <div className="text-center mt-4">
              <Link to={showImage} target="_blank">
                {showImage}
              </Link>
            </div>
            ...
            >
              <div>
                <div className="bg-white shadow-lg p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    <img
                      src="/src/assets/shoulderWidth.png"
              ...
              <div>
                <div className="bg-white shadow-lg p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    <img
                      src="/src/assets/leftArmLength.png"
                      className="w-28 h-28 object-cover"
                      alt=""
                    />
                    <div className="text-center">
              ...
              <div>
                <div className="bg-white shadow-lg p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    <img
                      src="/src/assets/torsolength.png"
                      className="w-28 h-28 object-cover"
                      alt=""
                    />
                    <div className="text-center">
              ...
              <div>
                <div className="bg-white shadow-lg p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    <img
                      src="/src/assets/leftLegLength.jpg"
                      className="w-28 h-28 object-cover"
                      alt=""
                    />
                    <div className="text-center">
