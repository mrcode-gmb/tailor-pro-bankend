      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className='bg-white p-3 rounded-lg shadow-md'>
            <div className="flex items-center gap-3 mt-0 max-md:mt-4 flex-wrap">
            <li className="list-none px-5 py-2.5 font-semibold rounded-lg transition-all duration-300 bg-none bg-green-500 text-white hover:bg-white hover:shadow-md cursor-pointer">
                <Link
                href=''
            ...
            <li className="list-none px-5 py-2.5 font-semibold rounded-lg transition-all duration-300 bg-none hover:bg-white hover:shadow-md cursor-pointer">
                <Link
                href=''
          ...
          <div className="w-full">
            <div className="w-11/12 m-auto bg-white relative flex flex-col flex-auto min-w-0 p-3 mt-10 overflow-hidden break-words border-0 shadow-blur dark:shadow-soft-dark-xl dark:bg-gray-200 rounded-2xl bg-white/80 bg-clip-border backdrop-blur-2xl backdrop-saturate-200 shadow-lg">
              <div className="flex max-md:block justify-between items-center w-full p-2">
                ...
                <div className="flex items-center">
                  <li className="list-none px-5 py-2.5 font-semibold rounded-lg transition-all duration-300 bg-none hover:bg-white cursor-pointer">
                    <Link
                      href=""
                      className="flex text-gray-600 gap-3 items-center"
                    >
