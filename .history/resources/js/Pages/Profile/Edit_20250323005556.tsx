      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className='bg-white p-3 rounded-lg shadow-md'>
            ...
            <li className="list-none px-7 py-2.5 font-semibold rounded-lg transition-all duration-300 bg-none bg-green-500 text-white hover:bg-white hover:shadow-md cursor-pointer">
                <Link
                href=''
