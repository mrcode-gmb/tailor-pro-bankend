      ...
      <section>
        <div className="2xl:w-10/12 relative xl:w-10/12 md:w-full sm:w-100  px-7 ml-auto">
          ...
          <div className="w-full">
            <div className="w-11/12 m-auto bg-white relative flex flex-col flex-auto min-w-0 p-3  overflow-hidden break-words border-0 shadow-blur dark:shadow-soft-dark-xl dark:bg-gray-200 rounded-2xl bg-white/80 bg-clip-border backdrop-blur-2xl backdrop-saturate-200 shadow-lg">
