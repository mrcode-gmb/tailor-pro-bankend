...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tailoring_tasks', function (Blueprint $table) {
            ...
            $table->enum("order_status", ['pending', 'cutting', 'sewing', 'completed', 'delivered', 'cancelled'])->default("pending")->comment("Specific style details given by the customer")->nullable();
            $table->string("price")->nullable()->comment("task amount customer paid");
            $table->string("payment_status")->nullable()->comment("task amount customer paid");
            $table->timestamps();
        });
    }
