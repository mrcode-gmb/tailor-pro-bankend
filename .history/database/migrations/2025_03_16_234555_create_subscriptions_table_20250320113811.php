...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('subscriptions', function (Blueprint $table) {
            ...
            $table->enum("plan_type", ['monthly', 'quarterly', 'yearly', 'custom'])->default("custom")->comment("Type of subscription");
            ...
            $table->enum("status", ['active', 'expired', 'cancelled', 'paused'])->comment("Current subscription status");
            $table->enum("renewal", [true, false])->default(false)->comment("Whether subscription auto-renews")->nullable();
            $table->timestamps();
        });
    }
