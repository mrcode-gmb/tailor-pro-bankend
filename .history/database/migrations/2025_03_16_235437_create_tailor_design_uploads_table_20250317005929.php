...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tailor_design_uploads', function (Blueprint $table) {
            ...
            $table->string("description")->comment("Additional details about the design")->nullable();
            $table->string("price_range")->comment("Estimated price range for the design")->nullable();
            $table->enum("status", ['public', 'private', 'draft'])->default("public")->nullable()l
            $table->timestamps();
        });
    }
